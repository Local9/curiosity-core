...
namespace NativeUI
{
    public class MediumMessageBase : BaseScript
    {
        public static MediumMessageHandler MessageInstance { get; set; }

        public MediumMessageBase()
        {
            MessageInstance = new MediumMessageHandler();
            Tick += MediumMessageTick;
        }

        private async Task MediumMessageTick()
        {
