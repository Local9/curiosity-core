...
namespace Curiosity.Core.Client.Utils
{
    public class Props : BaseScript
    {
        ...
        public static void SetSpeaker(int prop, int station)
        {
        ...
        //private static Task UpdateProps()
        //{
        ...
        public static readonly string[] SpeakerList = new string[]
        {
            "prop_speaker_01",
            "prop_speaker_02",
            "prop_speaker_03",
        ...
        public static readonly string[] BoozeList = new string[]
        {
