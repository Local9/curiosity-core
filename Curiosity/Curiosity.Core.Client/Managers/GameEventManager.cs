...
namespace Curiosity.Core.Client.Managers
{
    ...
    public class GameEventTigger : Manager<GameEventTigger> // THIS Could just be moved
    {
        ...
        async Task OnRespawnControlTask() // Change to a camera
        {
            ...
            ScreenInterface.DrawTextLegacy($"~w~(Press Q to respawn at a hospital ~g~${Cache.Player.Character.RespawnCharge() * 2}~w~)", 0.3f, new Vector2(0.5f, 0.79f), Color.FromArgb(175, 175, 175), true);
