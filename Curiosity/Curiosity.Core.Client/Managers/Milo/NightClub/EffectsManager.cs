...
namespace Curiosity.Core.Client.Managers.Milo.NightClub
{
    public class EffectsManager : Manager<EffectsManager>
    {
        ...
        internal async void CreateLight(int firstRandom, int secondRandom)
        {
            ...
            var pos = GetObjectOffsetFromCoords(c.X, c.Y, c.Z, 0f, posNightClubInterior.X, posNightClubInterior.Y, posNightClubInterior.Z - 2f);
        ...
        public async void AddSmokeParticles()
        {
