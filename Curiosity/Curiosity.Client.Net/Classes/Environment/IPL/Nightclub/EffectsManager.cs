...
namespace Curiosity.Client.net.Classes.Environment.IPL.Nightclub
{
    class EffectsManager
    {
        ...
        {
            client.RegisterTickHandler(NightClubLightAnimations);
        }
        ...
        internal static async void CreateLight(int club, int firstRandom, int secondRandom)
        {
        ...
        private static List<int[]> lightColors = new List<int[]>()
        {
                       //  r    g    b    a
        ...
        static int newLightTimer1 = GetGameTimer();
        static int newLightTimer2 = GetGameTimer() + 2000;
        static int newLightTimer3 = GetGameTimer() + 4000;
        static int newLightTimer4 = GetGameTimer() + 6000;


        static string RandomBeam => new string[8] { "ba_prop_battle_lights_fx_riga", "ba_prop_battle_lights_fx_rigb", "ba_prop_battle_lights_fx_rigc", "ba_prop_battle_lights_fx_rigd", "ba_prop_battle_lights_fx_rige", "ba_prop_battle_lights_fx_rigf", "ba_prop_battle_lights_fx_rigg", "ba_prop_battle_lights_fx_righ" }[randomizer.Next(0, 8)];

        static int step = 0;

        private static async Task RefreshLights(int club)
        {
        ...
        public static async Task NightClubLightAnimations()
        {
