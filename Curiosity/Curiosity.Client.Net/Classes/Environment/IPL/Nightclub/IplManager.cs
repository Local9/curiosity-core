...
namespace Curiosity.Client.net.Classes.Environment.IPL.Nightclub
{
    class IplManager
    {
        /// <summary>
        ...
        public static void Init()
        {
            ...
            if (!IsIplActive("ba_barriers_case7"))
            {
                RequestIpl("ba_barriers_case7");
            }

            if (!IsIplActive("ba_case7_taleofus"))
            {
                RequestIpl("ba_case7_taleofus");
            }

            if (IsIplActive("ba_case7_forsale"))
            {
                RemoveIpl("ba_case7_forsale");
            }

            client.RegisterTickHandler(InteriorChecker);
        }

        public static async Task InteriorChecker()
        {
        ...
        private static List<string> emitters = new List<string>()
        {
        ...
        private static List<string> djRadioStations = new List<string>()
        {
        ...
        private static List<int> interiorPeds = new List<int>();

        private static void InteriorChanged(bool enteredInterior)
        {
            if (enteredInterior)
            {
                ...
                EnableInteriorProp(NIGHTCLUB_INTERIOR_ID, "Int01_ba_clubname_04");          // Name (galaxy)
                EnableInteriorProp(NIGHTCLUB_INTERIOR_ID, "Int01_ba_Style03");              // Style (traditional)
                EnableInteriorProp(NIGHTCLUB_INTERIOR_ID, "Int01_ba_style03_podium");       // Podium (traditional)
                ...
                EnableInteriorProp(NIGHTCLUB_INTERIOR_ID, "Int01_ba_dj04");                 // DJ Booth (variant 3)
                EnableInteriorProp(NIGHTCLUB_INTERIOR_ID, "DJ_03_Lights_01");               // Droplets neon lights (variant 4)
                EnableInteriorProp(NIGHTCLUB_INTERIOR_ID, "DJ_02_Lights_02");               // Neons neon lights (variant 4)
                EnableInteriorProp(NIGHTCLUB_INTERIOR_ID, "DJ_03_Lights_03");               // Band neon lights (variant 4)
                EnableInteriorProp(NIGHTCLUB_INTERIOR_ID, "DJ_04_Lights_04");               // Lasers neon lights (variant 4)
                ...
                EnableInteriorProp(NIGHTCLUB_INTERIOR_ID, "Int01_ba_trophy04");             // Chest in VIP lounge
                DisableInteriorProp(NIGHTCLUB_INTERIOR_ID, "Int01_ba_dj01");                 // Dixon DJ posters
                DisableInteriorProp(NIGHTCLUB_INTERIOR_ID, "Int01_ba_dj02");                // Remove other posters
                EnableInteriorProp(NIGHTCLUB_INTERIOR_ID, "Int01_ba_dj03");                // Remove other posters
        ...
        static void DisableWeapons(bool state)
        {
        ...
        public static async void StartTv()
        {
        ...
        private static async void CreatePeds()
        {
