...
using Curiosity.Interface.Client.Environment;
using Curiosity.Interface.Client.Environment.Entities.Models;
using Curiosity.Interface.Client.Events;
using Curiosity.Interface.Client.Interface.Menus.Creator;
using Curiosity.Interface.Client.Interface.Menus.Data;
using Curiosity.Systems.Library.Models;
using System;
using System.Collections.Generic;
using System.Threading.Tasks;

namespace Curiosity.Interface.Client.Extensions
{
