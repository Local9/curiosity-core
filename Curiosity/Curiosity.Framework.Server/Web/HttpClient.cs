...
namespace Curiosity.Framework.Server.Web
{
    ...
    public class RequestInternal : BaseScript
    {
        ...
        public async Task<Dictionary<string, dynamic>> HttpAsync(string url, string method, string data, dynamic headers)
        {
            ...
            var token = PerformHttpRequestInternal(json, json.Length);
    ...
    public class Request : BaseScript
    {
            ...
            Dictionary<string, string> headers = null)
        {
            ...
            return ParseRequestResponseInternal(
                await Exports[GetCurrentResourceName()].HttpRequest(url, method, data, headers)
            );
        }
