...
namespace Curiosity.MissionManager.Client.Interface
{
    ...
    {
        public static void Success(string message, string position, string theme = "snackbar")
        {
            API.PlaySoundFrontend(-1, "package_delivered_success", "DLC_GR_Generic_Mission_Sounds", true);
            UxNotification(Notification.NOTIFICATION_SUCCESS, message, position, theme);
        }

        public static void Info(string message, string position, string theme = "snackbar")
        {
            API.PlaySoundFrontend(-1, "INFO", "HUD_FRONTEND_DEFAULT_SOUNDSET", true);
            UxNotification(Notification.NOTIFICATION_INFO, message, position, theme);
        }
        public static void Error(string message, string position, string theme = "snackbar")
        {
            API.PlaySoundFrontend(-1, "ERROR", "HUD_FREEMODE_SOUNDSET", true);
            UxNotification(Notification.NOTIFICATION_ERROR, message, position, theme);
        }

        public static void Warning(string message, string position, string theme = "snackbar")
        {
            API.PlaySoundFrontend(-1, "tyre_health_warning", "DLC_sum20_Open_Wheel_Racing_Sounds", true);
            UxNotification(Notification.NOTIFICATION_WARNING, message, position, theme);
        }

        public static void Show(string message, string position, string theme = "snackbar")
        {
            API.PlaySoundFrontend(-1, "SELECT", "HUD_FREEMODE_SOUNDSET", true);
            UxNotification(Notification.NOTIFICATION_SHOW, message, position, theme);
        }
    ...
    public static class HelpMessage
    {
        ...
        public static Dictionary<Label, KeyValuePair<string, string>> HelpTextLabels = new Dictionary<Label, KeyValuePair<string, string>>()
        {
            ...
            [Label.MENU_OPEN] = new KeyValuePair<string, string>("MENU_OPEN", $"~w~Press ~INPUT_C3FC7868~ ~w~to open menu."),
        };
