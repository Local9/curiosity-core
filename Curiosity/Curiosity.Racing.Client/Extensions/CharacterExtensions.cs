...
using Curiosity.Racing.Client.Environment;
using Curiosity.Racing.Client.Environment.Entities.Models;
using Curiosity.Racing.Client.Events;
using Curiosity.Racing.Client.Interface.Menus.Creator;
using Curiosity.Racing.Client.Interface.Menus.Data;
using Curiosity.Systems.Library.Models;
using System;
using System.Collections.Generic;
using System.Threading.Tasks;

namespace Curiosity.Racing.Client.Extensions
{
