...
using Curiosity.Library.Client.Enums;
using System.Collections.Generic;
using System.Linq;

namespace Curiosity.Library.Client
{
    /// <summary>
    /// Some control keycodes to get you started: https://docs.fivem.net/docs/game-references/controls/
    /// Alternatively, type /dev keycodetester in-game and press a key you wish to use
    /// Be careful as control codes can be bound to multiple keys as well
    ...
    public static class ControlUtility
    {
        ...
        {
            return !API.IsInputDisabled(controllerControlGroup);
        }
