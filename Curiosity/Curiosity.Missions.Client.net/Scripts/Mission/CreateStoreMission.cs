    ...
    class CreateStoreMission
    {
        ...
        static public async Task Create(Store store)
        {
            ...
            try
            {
                ...
                SoundManager.PlayAudioFile($"RESIDENT/DISPATCH_INTRO_0{Client.Random.Next(1, 3)} UNITS_RESPOND/UNITS_RESPOND_CODE_02_0{Client.Random.Next(1, 3)} WE_HAVE/WE_HAVE_0{Client.Random.Next(1, 3)} CRIMES/CRIME_ROBBERY_0{Client.Random.Next(1, 5)}");
        ...
        static public async void CleanUp(bool cancelMission = false)
        {
            ...
            SoundManager.PlayAudioFile($"RESIDENT/DISPATCH_INTRO_0{Client.Random.Next(1, 3)} REPORT_RESPONSE/REPORT_RESPONSE_COPY_0{Client.Random.Next(1, 5)}");
