...
namespace Curiosity.Server.net.Database
{
    public class DatabaseUsersBank : BaseScript
    {
        ...
        {
            string query = "UPDATE curiosity.character_bank set `wallet` = `wallet` + @wallet where characterBankId = @characterBankId;";
        ...
        {
            string query = "UPDATE curiosity.character_bank set `bankAccount` = `bankAccount` + @bankAccount where characterBankId = @characterBankId;";
            Dictionary<string, object> myParams = new Dictionary<string, object>();
            myParams.Add("@characterBankId", characterBankId);
