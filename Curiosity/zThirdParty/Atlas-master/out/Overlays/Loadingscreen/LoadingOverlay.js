    ...
    startInitFunctionOrder: (data) => {
        ...
        switch (data.type) {
            case "INIT_BEFORE_MAP_LOADED":
                Overlay.loadingLabel = "Förbereder inför kartan";

                break;
            case "MAP":
                Overlay.loadingLabel = "Laddar in kartan";

                break;
            case "INIT_AFTER_MAP_LOADED":
                Overlay.loadingLabel = "Sätter upp kartan";

                break;
            case "INIT_SESSION":
                Overlay.loadingLabel = "Sätter upp sessionen";
